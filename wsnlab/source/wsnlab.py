...
class Addr:
    ...
    ############################
    def __netAddr__(self):
        return self.net_addr

    ############################
    def __nodeAddr__(self):
    ...
    def __eq__(self, other):
        ...
        """
        if self.net_addr is None or other is None:
            return False
...
class Node:
    ...
    def send(self, pck):
        ...
        if config.CANSEND is True:
            if config.HEARTBEAT_PROBLEM is True and pck['type'] == "HEART_BEAT":
                pass
            else:
                pass
